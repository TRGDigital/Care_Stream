...
export const POLICY_PRODUCTS_SEED: SeedProduct[] = [
  ...
  { slug: 'lone-working', title: 'Lone Working Policy', price_pence: 4900, bundles: [HS],
    description: 'Risk assessing lone work, check-in and escalation, and what happens when a worker cannot be reached.',
    fields: [{ key: 'lone_working_lead', label: 'Lone working lead' },
             { key: 'out_of_hours_contact', label: 'Out of hours contact',
               help: 'The number a lone worker rings when there is no manager on site' }] },

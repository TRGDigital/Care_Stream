      ...
      <div className="space-y-5">
        ...
        <SectionBlock title="Import your whole team from a spreadsheet (CSV)">
          ...
          <div className="mt-3 space-y-3">
            ...
            <Step n={4}><strong>Import.</strong> Before you press Import, choose the <strong>staff type</strong> for the file: <em>New starters</em> are automatically enrolled in the onboarding flows matching their job roles, <em>Existing staff members</em> are not. Accounts are then created one by one; when it finishes you see every temporary password once, can download them all as a CSV, and can optionally have each person emailed their own login automatically.</Step>
            <Step n={5}><strong>Assign training.</strong> On the completion screen, click <strong>Assign training to all</strong> to give every imported person the same training in one go, statutory modules are pre-selected, just as when you add someone individually. You can fine-tune individuals from their staff record afterwards. (Training-only accounts allocate their purchased licences from the Training page instead.)</Step>
          </div>
          <div className="mt-3"><Tip>The import creates accounts exactly as the Add staff member form does, so plan staff limits apply and each person appears on the Staff page immediately with their onboarding and training already in place.</Tip></div>
        </SectionBlock>
    ...
    content: (
      <div className="space-y-5">
        ...
        <SectionBlock title="Out-of-date content — superseded law, regulators and placeholders">
          ...
          <ul className="ml-1 space-y-1.5 text-sm text-neutral-dark">
            <li className="flex gap-2"><CheckCircle size={15} className="mt-0.5 shrink-0 text-teal" /><span><strong>A clear list</strong>: each flagged policy shows how many issues were found, so you can see at a glance which ones need attention.</span></li>

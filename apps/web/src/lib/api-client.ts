...
export function createApiClient(token: string) {
  return {
    ...
    analytics: {
      ...
      adoptionContext: () => apiFetch<{ enabled: boolean; variables: Array<{ key: string; label: string; value: string }>; role_holders: Array<{ key: string; role: string; candidates: string[] }>; logo_url: string | null; home_name: string; address: string; registered_manager: string; default_approver: string; review_cycle_months: string; version_scheme: string }>('/analytics/gaps/adoption-context', token),

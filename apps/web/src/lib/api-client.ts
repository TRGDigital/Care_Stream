...
export function createApiClient(token: string) {
  return {
    ...
    analytics: {
      ...
      policyDocumentsSummary: () => apiFetch<{ documents: Array<{ policy_id: string; pending: number; version: string; published_at: string | null; approval_status: string }> }>('/analytics/gaps/policy-documents-summary', token),

  ...
  return {
    ...
    me: {
      ...
      annualTraining: {
        ...
        certificate: (id: string) => apiFetch<{ staff_name: string; module_name: string; org_name: string; logo_url: string | null; completed_at: string; expires_at: string | null; frequency: string; requires_practical: boolean; score: number; cpd: { accredited: boolean; hours: number | null; provider_number: string | null } }>(`/me/annual-training/${id}/certificate`, token),

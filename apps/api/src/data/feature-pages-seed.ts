...
//
// GENERATED by carestream-theme-preview/gen_features_seed.py from the approved content theme.
// Every string is checked back against the theme page it came from, so none of it is
// rewritten. meta_title, meta_description and sort are not in the theme and are carried
// forward from the previous seed rather than regenerated.
//
...
// the children.
//
// web-chat-interface is the one single page here, and the only one carrying the body fields.
// It is hand-built in the theme with its own markup, but its sections map onto the same shape
// every other feature page stores: the bespoke part is the design, not the content model.
...
export interface FeaturePageSeed {
  ...
  content: {
    ...
    outcomes?: string[]
    howItWorks?: { heading: string; intro: string; sections: { heading: string; body: string }[] }
    keyPoints?: string[]
    sidebar?: { title: string; body: string }[]
    whyItWorks?: { heading: string; intro: string; tiles: { title: string; body: string }[] }
    /** Screenshots beside each howItWorks section, in the same order. */
    stepImages?: string[]
  }
        ...
        "tiles": [
          {
            ...
            "body": "Staff get an instant, accurate answer at the point of care, instead of pausing to find someone to ask."
          },
          {
            "title": "From your policies",
            "body": "Grounded in your own documents, so the guidance reflects your service, not a template."
          },
          {
            "title": "In any language",
            "body": "Over 60 languages supported, so every member of the team can use it with confidence."
          },
          {
            "title": "Surfaces the gaps",
            "body": "Questions your policies can't answer are captured, so you can see and close the gaps."
          }
        ]
      },
      "stepImages": [
        "/images/features/web-chat-interface/2.webp",
        "/images/features/web-chat-interface/3.webp",
        "/images/features/web-chat-interface/4.webp",
        "/images/features/web-chat-interface/5.webp",
        "/images/features/web-chat-interface/6.webp",
        "/images/features/web-chat-interface/7.webp"
      ]
    },
    "faqs": [
      {

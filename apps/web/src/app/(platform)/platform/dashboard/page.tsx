    ...
    <div className="space-y-3" ref={containerRef}>
      ...
      <RefSection icon={Globe} title="Language Detection & Multilingual Responses">
        ...
        <div className="mt-3 space-y-1">
          ...
          <RefRow label="Translation glossary" value="Per-tenant term-locking. tenant.translation_glossary (JSON [{term,keep,note}]) edited in Settings → Translation glossary. buildGlossary() in translate.ts appends a 'keep verbatim / follow this note' instruction to every translate prompt (questions, texts, HTML/policy, bundle) and partitions the translation_cache by a 12-char glossary sig (langCode#sig) so a glossary change never serves a stale cache. Wired through me.ts, training.ts, cqc-staff-questions.ts, onboarding.ts, query.ts, proactive.ts, conversation.ts. Backward-compatible optional param; no glossary → unchanged." />

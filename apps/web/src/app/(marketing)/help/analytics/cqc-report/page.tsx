...
export const metadata = {
  ...
  description: 'How to generate and download a CQC Readiness Report in CareStreamAI, bringing your evidence across the five key questions together in one document.',
}

...
const EMAIL_PREFS = [
  ...
  { key: 'cqc_staff_prep',         label: 'CQC staff prep',            description: 'Notifications when CQC practice questions are sent to staff. Questions are generated to match each person\u2019s job role (a chef gets food safety, a nurse gets medicines) plus a core set for everyone, scoped to the CQC domains you choose \u2014 each staff member gets one notification per round.',                                               category: 'service'   },
  ...
  { key: 'compliance_expiry_alerts', label: 'Compliance credential expiry', description: 'A digest when staff credentials (DBS, right to work, professional registration) are expiring soon or have expired. Enterprise only.',                        category: 'service'   },
  { key: 'supervision_updates',    label: 'Supervisions & appraisals',  description: 'Booking confirmations to staff, and day-before reminders to staff and admins for scheduled supervisions and appraisals. Enterprise only.',                     category: 'service'   },
    ...
    <div>
      ...
      <div ref={sectionsRef} className="space-y-3">
        ...
        <SettingSection icon={UserRound} title="Organisation details" description="Names and details used to personalise your policies. Set them once and they are referenced across your policies, so if something changes you update it here and the policies follow.">
          <p className="mb-4 text-sm text-neutral-mid">
            These are your policy <strong>merge fields</strong>. Role-holder names appear beside the role wherever a policy mentions it, and on the sign-off and header of any policy you download. Update them here and the policies follow, with no need to re-adopt.
          </p>

...
export const DRAFTS_CORE: OnboardingEmail[] = [
  ...
  {
    draft: true,
    subject:   'Over thirty audits, ready to run this morning',
    preheader: 'Medicines, falls, safeguarding, mealtimes, water safety and more, already written.',
    headline:  'The audit you were going to write already exists',
    intro: [
      'Most services audit the same handful of things because those are the forms somebody once made. The gaps are rarely deliberate. Nobody has had a spare afternoon to write a falls audit from scratch.',
      'CareStream includes over thirty ready-made audits written for UK care settings, covering medicines, infection control, fire safety, safeguarding, falls, pressure care, mealtimes, night walkrounds, water safety, HR files and more. Every question is tagged with the CQC quality statement it evidences, so the report shows inspectors exactly what it covers.',
    ],
    steps: [
      { title: 'Open Monthly Audits', body: 'Available audits are grouped by how often they run, from daily checks to quarterly reviews.' },
      { title: 'Start one', body: 'Choose New audit, pick the audit and the month, and work through it on any device.' },
      { title: 'Tidy the list', body: 'Hide any audit you do not use so your team only sees what matters, and bring it back whenever you want.' },
    ],
    tip: 'Pick the audit you have been meaning to write and run it this week. A first run tells you more about your service than a perfect form you never finish.',
    where: 'Monthly Audits, Available audits',
    ctaLabel: 'See your audit library',
    ctaHref:  '/audits',
  },
  {
    draft: true,
    subject:   'Nobody has to remember when the audit is due',
    preheader: 'Assign each audit to a person with a due date, and let the reminders do the chasing.',
    headline:  'Audits that chase themselves',
    intro: [
      'The reason audits slip is rarely that people do not care. It is that the person who remembers is on annual leave, and the audit that should have happened in week two gets done in a rush at the end of the month.',
      'Schedule an audit to a named member of staff with a due date and a repeat, and CareStream takes over the chasing. They are emailed when it is assigned, two days before it is due, and when it becomes overdue. If it stays overdue, it is escalated to your managers.',
    ],
    steps: [
      { title: 'Schedule an audit', body: 'Choose the audit, the person, the due date and whether it repeats daily, weekly, monthly or quarterly.' },
      { title: 'Let them get on with it', body: 'It appears in their hub under Assigned to you, and the next one is set up automatically when they finish.' },
      { title: 'Watch the filters, not the diary', body: 'Overdue, Due in 7 days, All open, and Done and missed tell you where everything stands at a glance.' },
    ],
    tip: 'In Settings, Audits you choose how many days overdue an audit can be before managers are told, and whether your admins get a daily or weekly summary.',
    where: 'Monthly Audits, Scheduled audits',
    ctaLabel: 'Schedule your first audit',
    ctaHref:  '/audits',
  },
  {
    draft: true,
    subject:   'Circle the problem instead of describing it',
    preheader: 'Photos on the question itself, marked up as you walk the floor.',
    headline:  'The evidence, taken where you found it',
    intro: [
      'Writing "wardrobe not secured to the wall" in a findings box relies on whoever reads it picturing the same thing you saw. A photo removes the guesswork, and a photo with a circle around the bracket removes it entirely.',
      'On a phone or tablet, your team can take a photo on any audit question and draw on it before it is saved, so the person reading the report sees exactly what was wrong. The image is compressed automatically, so it uploads even on care home wifi.',
    ],
    steps: [
      { title: 'Do the audit in the hub', body: 'Open Audits in the Chat Hub and work through it as you walk the floor.' },
      { title: 'Take the photo on the question', body: 'Tap Add, take the photo or choose one, then circle or arrow the problem.' },
      { title: 'Read it back with the evidence', body: 'The photos sit under the answer in the audit and in the report, not in a separate folder.' },
    ],
    tip: 'Photograph the good as well as the bad. A before and after pair is the clearest evidence that an action worked.',
    where: 'Chat Hub, Audits, a question with photos',
    ctaLabel: 'Try it on your next audit',
    ctaHref:  '/audits',
  },
  {
    draft: true,
    subject:   'Every audit signed, and checked by a manager',
    preheader: 'On-screen signatures and manager sign-off, recorded on the report.',
    headline:  'Who did the audit, and who checked it',
    intro: [
      'An audit with no name on it is hard to stand behind. Inspectors ask who carried it out, what their role was, and who reviewed it, and "one of the seniors, I think" is not an answer.',
      'The auditor signs on screen with a finger or a mouse to confirm the audit is a true record. Turn on manager approval and the completed audit goes to your care manager in the hub to review and sign off, with an email letting them know it is waiting. Both signatures, names and dates are saved to the audit and printed on the report.',
    ],
    steps: [
      { title: 'Sign at the end', body: 'The auditor signs and types their name before the audit can be completed.' },
      { title: 'Turn on manager approval', body: 'In Settings, Audits, so completed audits go to your care manager to sign off.' },
      { title: 'Sign it off in the hub', body: 'The manager reviews the answers under Audit sign-off and signs, or sends it back with a note.' },
    ],
    tip: 'Manager sign-off is off by default. Turn it on for the audits that carry weight, like medicines and safeguarding.',
    where: 'The end of an audit, and Audit sign-off in the hub',
    ctaLabel: 'Set up manager sign-off',
    ctaHref:  '/settings',
  },
  {
    draft: true,
    subject:   'The audit report is written before you close the laptop',
    preheader: 'A signed PDF with every answer, the scores and the recommendations, emailed to your admins.',
    headline:  'No more typing up the audit afterwards',
    intro: [
      'The audit itself is rarely the slow part. The slow part is turning a clipboard into something you could hand to an inspector, which is why so many audits sit half written in a drawer.',
      'The moment an audit is completed, CareStream produces a PDF report with every answer and finding, each section score, the CQC quality statements covered, the signatures and the AI recommendations. It is saved with the audit and emailed to your admins automatically.',
    ],
    steps: [
      { title: 'Complete the audit', body: 'The report is generated as soon as you finish, or once the manager signs it off if approval is on.' },
      { title: 'Check your inbox', body: 'Your admins get the PDF by email, so the people who need it do not have to go looking.' },
      { title: 'Download it any time', body: 'Open any completed audit in the repository and choose Download PDF.' },
    ],
    tip: 'You can turn the email off in Settings, Audits if you would rather the report was simply saved with the audit.',
    where: 'A completed audit, and the PDF report',
    ctaLabel: 'See a completed report',
    ctaHref:  '/audits',
  },
  {
    draft: true,
    subject:   'An action is not closed until someone proves it',
    preheader: 'Assign findings to staff, get photos of the fix, and re-check at the next audit.',
    headline:  'The bit most audits never finish',
    intro: [
      'Inspectors rarely doubt that you audit. What they look for is what happened next, and that is where most audit trails go quiet. The finding is written down, somebody means to sort it, and the next audit finds the same thing.',
      'CareStream turns the recommendations into an action plan you assign to named staff. They close each action by saying what they did and adding photos of the fix, or ask for more time with a reason for a manager to agree or decline. At the next audit of the same kind, the auditor is asked whether each previous action is still fixed, and anything that is not is reopened.',
    ],
    steps: [
      { title: 'Approve the plan', body: 'Edit the drafted actions, set priorities and due dates, assign each one, then approve it.' },
      { title: 'Staff close their own actions', body: 'They see them in the hub under My actions, with reminders if they go overdue.' },
      { title: 'Re-check at the next audit', body: 'Actions from last time appear first, to mark Still fixed or Not fixed.' },
    ],
    tip: 'A reopened action is not a failure. It is the evidence that your audits are honest, which is exactly what a well-led service looks like.',
    where: 'The action plan, and My actions in the hub',
    ctaLabel: 'Open your action plan',
    ctaHref:  '/audits',
  },
  {
    draft: true,
    subject:   'The check that keeps failing, in one line',
    preheader: 'Scores over time, repeat failures flagged, and every home side by side.',
    headline:  'Whether things are actually getting better',
    intro: [
      'A single audit tells you about one morning. What you need for a governance meeting, or an inspection, is the direction of travel: are the same things going wrong, and is anything improving?',
      'Trends shows the percentage of checks met over the last 3 to 24 months, each audit\u2019s latest score and how it has changed, and which questions fail most often. Repeat failures, where the same check fails in consecutive audits, are flagged first, because they usually mean an action has not worked.',
    ],
    steps: [
      { title: 'Open Trends', body: 'It sits on the Monthly Audits page once you have completed audits to compare.' },
      { title: 'Start with the repeat failures', body: 'These are the problems that are coming back, not the ones that were fixed.' },
      { title: 'Open the detail', body: 'Choose Details on any audit to see which questions fail most and how each section is scoring.' },
    ],
    tip: 'If you run more than one home, Across your homes compares their audit scores side by side, so the service worth copying is as obvious as the one that needs help.',
    where: 'Monthly Audits, Trends',
    ctaLabel: 'See your audit trends',
    ctaHref:  '/audits',
  },
]
...
export const DRAFTS_ENTERPRISE: OnboardingEmail[] = [
  ...
  },
  {
    draft: true,
    badge: 'Enterprise feature',
    subject:   'Fridge temperatures, ratings, and questions that only appear when they matter',
    preheader: 'Build audits with nine question types, conditional questions and CQC tags.',
    headline:  'An audit that behaves like your paperwork does',
    intro: [
      'Real audits are not all yes or no. A medicines fridge has a range. A mealtime observation deserves a rating. And half the questions on a form only apply when the answer before them was wrong, which is why paper audits are covered in "if yes, state why".',
      'Your Enterprise plan lets you build exactly that. Choose from nine question types, including a number with a pass range so a reading outside it fails on its own, and set follow-up questions to appear only when an earlier answer needs them.',
    ],
    steps: [
      { title: 'Build your own audit', body: 'Add sections, then choose a type for each question: yes or no, number, date, choice, rating, findings and more.' },
      { title: 'Add the conditions', body: 'Set a question to appear only when an earlier answer matches, so nobody works through questions that do not apply.' },
      { title: 'Tag the CQC statement', body: 'Link each question to the quality statement it evidences, and it shows on the report.' },
    ],
    tip: 'Every save is a new version with a note of what changed, and completed audits keep the questions they were answered against, so improving an audit never rewrites an old report.',
    where: 'Monthly Audits, Build your own audit',
    ctaLabel: 'Build an audit',
    ctaHref:  '/audits',
  },
  {
    draft: true,
    badge: 'Enterprise feature',
    subject:   'Photograph your paper audit. We will type it up.',
    preheader: 'Import the audits you already use from a PDF, a Word file or a photo.',
    headline:  'Keep the audits your team already trusts',
    intro: [
      'The reason services stay on paper is rarely the paper. It is the thought of retyping twelve audits, each with sixty questions, before anything gets better.',
      'Upload the audit you use today as a PDF, a Word document, or simply a photo of the paper form. AI reads it, including scanned and handwritten forms, and builds it as a CareStream audit with the sections, question types, options and CQC tags filled in. You check it before anything is saved.',
    ],
    steps: [
      { title: 'Choose Import an existing audit', body: 'On the Monthly Audits page, upload the file or take a photo of the form.' },
      { title: 'Check what it read', body: 'The audit opens in the builder, with anything the AI was unsure about listed for you at the top.' },
      { title: 'Create it', body: 'Nothing is saved until you press Create audit, and you can edit every question first.' },
    ],
    tip: 'Start with your most-used paper audit. Once it is in, scheduling, photo evidence, signatures, reports and trends all apply to it like any other.',
    where: 'Monthly Audits, Import an existing audit',
    ctaLabel: 'Import your first audit',
    ctaHref:  '/audits',
  },
]

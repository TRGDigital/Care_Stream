...
settingsRouter.patch('/', async (req: Request, res: Response) => {
  ...
  if (organisation_details !== undefined) {
    ...
    const ALLOWED = new Set(['nominated_individual', 'address', 'cqc_location_id', 'cqc_provider_id', 'review_cycle_months', 'version_scheme', 'default_approver', 'show_role_names', 'require_manager_approval', 'require_external_approval', 'require_audit_manager_approval'])

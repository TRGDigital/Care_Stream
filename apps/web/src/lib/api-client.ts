...
export function createApiClient(token: string) {
  return {
    ...
    audits: {
      ...
      createRun: (data: { template_id: string; audit_month: string; auditor_name?: string; auditor_role?: string; room_number?: string; subject?: string }) =>

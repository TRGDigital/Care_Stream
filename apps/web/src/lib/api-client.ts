...
export function createApiClient(token: string) {
  return {
    ...
    analytics: {
      ...
      policyApprovals: (policyId: string) => apiFetch<{ status: string; external_name: string; external_email: string; external_token: string | null; external_sent_at: string | null; link_expired: boolean; default_external_name: string; default_external_email: string; approvals: Array<{ id: string; stage: string; decision: string; approver_name: string; approver_email: string; comment: string; created_at: string }> }>(`/analytics/gaps/policy-approvals/${encodeURIComponent(policyId)}`, token),

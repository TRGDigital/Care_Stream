    ...
    <div className="space-y-3">
      ...
      <RefSection icon={Lock} title="Staff Sign-In & Account Provisioning">
        ...
        <div className="mt-2 space-y-1">
          ...
          <RefRow label="Sessions"            value="Lengthened for 'stay signed in like WhatsApp': next-auth session.maxAge 90d + backend REFRESH_EXPIRY 90d (services/auth/tokens.ts). (Refresh token still not rotated — sliding-window rotation is a future hardening.)" />

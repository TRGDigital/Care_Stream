...
export function createApiClient(token: string) {
  return {
    ...
    me: {
      ...
      policyApprovals: () => apiFetch<{ is_manager: boolean; policies: Array<{ policy_id: string; name: string; version: string; changes: number; submitted_at: string }>; published: Array<{ policy_id: string; name: string; version: string; published_at: string; published_by: string }> }>('/me/policy-approvals', token),

  ...
  return {
    ...
    standardTraining: {
      catalogue: () => adminFetch<{
        ...
        topics: Array<{ id: string; title: string; group_key: string; default_frequency: string; requires_practical: boolean; aliases: string[]; module: null | { id: string; name: string; approved: boolean; approved_at: string | null; created_at: string; frequency: string; requires_practical: boolean; pass_mark: number; duration_minutes: number | null; question_count: number; illustration_url: string | null; image_count: number; image_slots: number; standards_count: number; attested_by_name: string | null; attested_by_role: string | null; attested_at: string | null; qa_hard_fails: number; qa_warnings: number; review_status: string | null; review_changes_open: number } }>

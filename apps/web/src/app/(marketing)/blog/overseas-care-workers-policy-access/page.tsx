...
export const metadata = {
  ...
  description: 'International care workers face a hidden compliance risk: policies written in a second language. Learn what this means for your team\'s safety and how AI can help.',
  openGraph: {
    title: 'The Hidden Risk in Your International Workforce',
    description: 'Policy access in a second language — the compliance risk most providers have not addressed.',
    url: 'https://carestreamai.co.uk/blog/overseas-care-workers-policy-access',
  },
}

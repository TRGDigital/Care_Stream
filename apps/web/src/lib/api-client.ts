...
export function createApiClient(token: string) {
  return {
    ...
    analytics: {
      ...
      policyApprovalsOverview: () => apiFetch<{ documents: Array<{ policy_id: string; name: string; version: string; approval_status: string; published_at: string | null; updated_at: string | null; pending: number; external_name: string; trail: Array<{ stage: string; decision: string; approver_name: string; created_at: string; comment: string }> }>; summary: { total: number; published: number; in_progress: number } }>('/analytics/gaps/approvals-overview', token),
